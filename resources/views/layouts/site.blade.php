                    ...
                    <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
                        <div class="flex grow items-center justify-between gap-20">
                            ...
                            <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-4 md:gap-5">
                                ...
                                <a href="{{ route('companies') }}" wire:navigate class="inline-block px-2 py-1.5 text-[#1b1b18] border border-transparent text-sm rounded-sm leading-normal {{ request()->routeIs('companies') || request()->routeIs('companies.*') ? 'bg-gray-200' : '' }}">Companies</a>

                                @if(!auth()->check() || (auth()->check() && auth()->user()->currentUserBelongsToCompany()))
