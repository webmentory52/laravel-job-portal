<aside class="col-span-12 md:col-span-3 space-y-6">
    ...
    <div x-data="{load_all: false}">
        ...
        <div class="flex items-center mb-1">
            <input type="radio" id="category_all" name="category" class="radio" value="" checked />
        ...
        @foreach($this->getCategories() as $category)
            <div class="flex items-center mb-1" wire:key="{{$category->id}}">
                <input type="radio" id="cat_{{$category->id}}" name="category" class="radio" value="{{$category->id}}" />
    ...
    <div>
        ...
        <div class="flex items-center mb-1">
            <input type="radio" id="jobtype_all" name="jobtype" class="radio" value="" checked />
        ...
        @foreach($this->jobTypes as $jobType)
            <div class="flex items-center mb-1" wire:key="{{$jobType->id}}">
                <input type="radio" id="jobtype_{{$jobType->id}}" name="jobtype" class="radio" value="{{ $jobType->id }}" />
    ...
    <div>
        ...
        <div class="flex items-center mb-1">
            <input type="radio" id="workplace_all" name="workplace" class="radio" value="" checked />
        ...
        @foreach($this->workPlaces as $workPlace)
            <div class="flex items-center mb-1" wire:key="{{$workPlace->id}}">
                <input type="radio" id="workplace_{{$workPlace->id}}" name="workplace" class="radio" value="{{ $workPlace->id }}" />
