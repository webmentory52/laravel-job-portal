<div>
    <section class="p-6 bg-white rounded mt-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold flex-1">{{$pageTitle}}</h1>
        ...
        <div class="grid grid-cols-12 gap-6">
            <!--Sidebar-->
            <livewire:shared.search-filters :showCategoriesFilter="false" :$keyword :$jobTypeId :$workPlaceId  @filter="handleFilter($event.detail)"  />
